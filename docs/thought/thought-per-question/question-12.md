...
<iframe src="https://www.youtube.com/embed/qflh4GKbmVQ?si=t0ic4rYNrfCh4VPl" title='In this video, Anton Korinek, a leading economist and professor at the University of Virginia, discusses the profound economic and social shifts driven by the "Fourth Industrial Revolution" (4IR, era of rapid technological transformation where the boundaries between the physical, digital, and biological worlds are blurring with Artificial Intelligence as its primary engine).' frameborder="0" allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
</div>
...
* [**AI's Application of Jevons Paradox**](../../survival/layoffs-and-survival-cases/index.md#jevons-paradox-ais-application) against [**Full Economics Collapse Scenario**](#full-economics-collapse-scenario): both the possibility of the "increasing demand in humans" and the possibility of full collapse of economics are being discussed.
...
1. Fired people, plumbers, maids and waiters do not bye services of BigCorp anymore.
1. BigCorp stays wealthy by switching to Government Contracts and BigPartner Contracts.
1. Government does not have money (see point about "no paying taxes") and do not bye services of BigCorp anymore.
...
* **RLHF:** The thousands of human "trainers" they hire to tell the AI which answers are good or bad[^1].
...
1. In AI Era, the **UBI > uninterrupted growth of population > UHI** chain is **mandatory** for all economical entities (including LLMs themselves) to survive.
...
1. For **UBI/UHI/keep population** to work, the schema of re-distributing of wealth should be dramatically re-shaped.
...
1. Is AI actually capable of doing "dramatic" things described in this article? If not, this completely changes the picture and all scenarios.
1. Is 1% of survivors scenario possible?

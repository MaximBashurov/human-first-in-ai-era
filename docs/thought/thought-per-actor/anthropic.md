...
**Birth as Separation**: The founders of Anthropic famously [left OpenAI](openai.md#the-2019-schism-anthropic-birth) because they felt it was becoming too commercial and moving too fast on capabilities without enough focus on **safety**.
...
??? info "The Adolescence of Technology"

    **"The Adolescence of Technology"** is the essay by Dario Amodei (Anthropic's CEO) [published](https://www.darioamodei.com/essay/the-adolescence-of-technology) in early January 2026. The essay is structured around his "battle plan" for overcoming the risks associated with powerful AI. Amodei defines this level of technology as a "country of geniuses in a datacenter"—millions of instances of AI, each smarter than a Nobel Prize winner, operating at 10-100x human speed.
...
Launched in March 2026, [**The Anthropic Institute**](https://www.anthropic.com/institute) is the company's dedicated effort to translate its research into real-world solutions for societal challenges.

* **Leadership:** Led by co-founder Jack Clark[^1] (Head of Public Benefit), it acts as a bridge between frontier AI research and public policy.
...
* [**Societal Impacts Team:**](https://www.anthropic.com/research/team/societal-impacts/) A technical team that works closely with Policy and Safeguards to explore how AI is used in the real world.
...
* **Data Sharing:** These agreements involve sharing "Economic Index" data and participating in joint safety evaluations with national AI Safety Institutes[^2].
...
??? info "See also: Anthropic’s Head of Safety QUITS With Chilling Warning"

    <div class="video-embed">
    <iframe src="https://www.youtube.com/embed/W9ivIwxSAWQ?si=93mITwbikb1p2j_q" title="This video is telling about the resignation of Anthropic’s Head of Safety, who left the company with a warning about the current trajectory of AI development.The video also covers several other major AI milestones and controversies from the same period." frameborder="0" allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
    </div>
...
<div class="video-embed">
<iframe src="https://www.youtube.com/embed/DC6OSydJQCA?si=08m1wcIHsb_8eLNN" title="This DW News report details the high-stakes confrontation in early 2026 between the AI company Anthropic and the U.S. Department of Defense (DoD)." frameborder="0" allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
</div>
